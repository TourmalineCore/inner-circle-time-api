...
{
    /// <inheritdoc />
    public partial class AddCkEntriesNoTimeOverlapConstraints_01 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Entry types: Task - 1, Unwell - 2, Away With Make-up time - 3, Make-up time - 4, Sick leave - 5, Vacation - 6
            migrationBuilder.Sql(@"
            ...
            migrationBuilder.Sql(@"
                ALTER TABLE tracked_entries
                ADD CONSTRAINT ck_entries_2_3_5_6_no_time_overlap
                EXCLUDE USING GIST (
                    tenant_id WITH =,
                    employee_id WITH =,
                    tsrange(start_time, end_time, '[)') WITH &&
                )
                WHERE (type IN (2, 3, 5, 6) AND deleted_at_utc IS NULL); 
            ");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ALTER TABLE tracked_entries 
                DROP CONSTRAINT IF EXISTS ck_entries_2_3_5_6_no_time_overlap;
            ");
