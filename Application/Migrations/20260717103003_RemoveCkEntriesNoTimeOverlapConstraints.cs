...
{
    /// <inheritdoc />
    public partial class RemoveCkEntriesNoTimeOverlapConstraints : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ALTER TABLE tracked_entries 
                DROP CONSTRAINT IF EXISTS ck_entries_2_3_4_no_time_overlap;
            ");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ALTER TABLE tracked_entries
                ADD CONSTRAINT ck_entries_2_3_4_no_time_overlap
                EXCLUDE USING GIST (
                    tenant_id WITH =,
                    employee_id WITH =,
                    tsrange(start_time, end_time, '[)') WITH &&
                )
                WHERE (type IN (2, 3, 4) AND deleted_at_utc IS NULL); 
            ");
        }
    }
}
